...
airfoil_0_Coordscsv = CSVReader(
    FileName=['F:\\Maestria\\Airfoil\\PreProcessing\\Points3D\\Airfoil_'
              +Nmbr+'_Coords.csv']
    # FileName=['/mnt/f/Maestria/Airfoil/Points3D/Airfoil_'+Nmbr+'_Coords.csv']
    )
...
# save data
SaveData(
    # '/mnt/f/Maestria/Airfoil/Stl/Airfoil_'+Nmbr+'.stl', 
    'F:\\Maestria\\Airfoil\\PreProcessing\\Stl\\Airfoil_'+Nmbr+'.stl', 
